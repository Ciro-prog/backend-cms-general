...
class PyObjectId(ObjectId):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler):
        """Schema para Pydantic v2 - REEMPLAZA __get_validators__"""
    ...
    @classmethod
    def __get_pydantic_json_schema__(cls, field_schema: Dict[str, Any], model_type=None) -> Dict[str, Any]:
        """JSON Schema para Pydantic v2 - REEMPLAZA __modify_schema__"""
        field_schema.update(
            type="string",
            format="objectid",
    ...
    @classmethod
    def _validate(cls, v: Any, info=None) -> 'PyObjectId':
        """Validador para Pydantic v2"""
        if v is None:
            return None
